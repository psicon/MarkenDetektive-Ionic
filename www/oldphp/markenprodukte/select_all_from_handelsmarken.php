...
$query2=mysql_query("SELECT COUNT(distinct mpID) as Anzahl FROM search_ALL");
        while($row2 = mysql_fetch_array($query2))
{
 	echo "<strong>Anzahl: $row2[0]</strong>";
	}
 	
	$query=mysql_query("SELECT DISTINCT mpID, mpBezeichnung, mpPreis, mpDatum, mpEAN, mpEAN2, mpEAN3, mpBeschreibung, mpPackungsgroesse, peBezeichnung, mpBild, mherName, mherBild FROM search_ALL ORDER BY mpBezeichnung");
